...
def get_exchange(exchange_id: str):
    ...
    if exchange_id == "binance":
        ...
        # Par défaut, ccxt charge aussi les marchés futures (fapi.binance.com)
        # et coin-margined (dapi.binance.com) en plus du spot, même si on n'en
        # a pas besoin ici. Or ces deux endpoints sont géo-bloqués (451) et
        # n'ont pas de miroir public équivalent à data-api.binance.vision.
        # On restreint donc le chargement au marché spot uniquement.
